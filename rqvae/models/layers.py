...
class MLPLayers(nn.Module):
    ...
    def __init__(
        self, layers, dropout=0.0, activation="relu", bn=False, norm_type: str = "none"
    ):
        ...
        self.norm_type = (norm_type or "none").lower()
        ...
        for idx, (input_size, output_size) in enumerate(
            ...
            if idx != (len(self.layers)-2):
                if self.norm_type == "batchnorm" or (self.use_bn and self.norm_type == "none"):
